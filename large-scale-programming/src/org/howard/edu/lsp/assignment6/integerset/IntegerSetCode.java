...
public class IntegerSetCode {
	private List<Integer> set = new ArrayList<Integer>();
	
	public IntegerSetCode(ArrayList<Integer> set) {
		this.set = set;
	}
     ...
     */
	public boolean equals(IntegerSetCode b) {
	...
	public int largest() throws IntegerSetCodeException {
		// If set is empty, console will the exception that it's empty
		if (set.size() == 0) {
            throw new IntegerSetCodeException("Set is Empty");
        }
	...
	public int smallest() throws IntegerSetCodeException {
		// If set is empty, console will the exception that it's empty
		if (set.size() == 0) {
			throw new IntegerSetCodeException("Set is Empty");
        }
	...
	// Removes an item from the set or does nothing if not there
 	...
 	// Set union
	public void union(IntegerSetCode intSetb) {
 	...
 	// Set intersection
 	public void intersect(IntegerSetCode intSetb) {
 		ArrayList<Integer> temp = (ArrayList<Integer>) intSetb.getSet();
 	...
 	public void diff(IntegerSetCode intSetb) {
 		ArrayList<Integer> temp = (ArrayList<Integer>) intSetb.getSet();
